...
var app = (function()
{
	...
	var mRegionData =
	{
		'region1': 'Brendan\'s iBeacon',
        'region2': 'Shawn\'s iBeacon',
        'region3': 'Estimote Beacon'
	};
...
//			+	'Proximities: ' + mNearestBeacon.proximity + '<br />'
...
//			);
       ...
       // $('#appbody').innerHTML = "this does work";
        
        $('#test').append(tester);
//        var title = $('Does not change');
//        
//        if (mNearestBeacon.major == 19175){
